...
if __name__ == "__main__":
    ...
    selected_tools = [
        ...
        CopyPathsTool(root_path=project_root, permission_required=False),
        RenamePathTool(root_path=project_root, permission_required=False),
        MovePathsTool(root_path=project_root, permission_required=False),
        PathStatTool(root_path=project_root, permission_required=False),
